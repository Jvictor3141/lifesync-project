...
const Sidebar = ({ isOpen, onClose, currentSection, onSectionChange }) => {
  ...
  return (
    <>
      ...
      {/* Sidebar */}
      <nav className={`
        fixed top-0 left-0 h-full w-80 bg-white shadow-xl z-50 border-r border-purple-100
        dark:bg-gray-800 dark:border-gray-700
        transform transition-transform duration-300 ease-in-out
        ${isOpen ? 'translate-x-0' : '-translate-x-full'}
      `}>
        <div className="p-0">
          <div className="flex items-center justify-between mb-8 bg-pink-500 px-4 py-6">
                ...
                <li key={item.id}>
                  <Button
                    ...
                    className={`
                      ...
                      ${currentSection === item.id ? 'bg-pink-100 dark:bg-gray-700' : ''}
                    `}
